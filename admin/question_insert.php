...
<input type="hidden" name="chapter_code" value="<?php echo $chapter_code; ?>">
  	...
  	<div class="question_name">
       ...
       <td><?php echo $i; ?>. question name<input style="width: 50%; margin-left: 25%; padding: 5%;" type="text" name="ques[]" class="form-control"  required/></td>

         	<table class="table table-bordered my_table">
			<tr>
	           <td>Option one<input type="text" name="op1[]" class="form-control" required></td>
	           <td>Option two<input type="text" name="op2[]" class="form-control" required></td>
	           <td>Option three<input type="text" name="op3[]" class="form-control" required></td>
	           <td>Option four<input type="text" name="op4[]" class="form-control" required></td>
	        </tr>
    	</table>
        	 Right Answer<input style="width: 50%; margin-left: 25%; padding: 2%;" type="text" name="cor_ans[]" class="form-control"  required/>
